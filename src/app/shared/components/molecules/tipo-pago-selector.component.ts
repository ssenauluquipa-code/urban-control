...
@Component({
  ...
  styles: [`
    ...
    ::ng-deep .ant-radio-group-large {
      display: flex !important;
      width: 100%;
      height: 42px; /* Altura estándar para large */
    }
    ...
    ::ng-deep .ant-radio-button-wrapper-checked:not(.ant-radio-button-wrapper-disabled) {
      background: #1890ff; /* Color primario */
      color: white;
      box-shadow: -1px 0 0 0 #1890ff;
    }

    ::ng-deep .ant-radio-button-wrapper:first-child {
      border-radius: 8px 0 0 8px;
    }

    ::ng-deep .ant-radio-button-wrapper:last-child {
...
export class TipoPagoSelectorComponent {
  ...
  @Input() input_control: FormControl<TipoPago | null> = new FormControl<TipoPago | null>(TipoPago.CONTADO);
